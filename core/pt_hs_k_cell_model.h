        ...
        namespace pt_hs_k {
            ...
            */
            struct all_response_collector {
                ...
                pts_t snow_outflow;///< gamma snow output [mm/h] for the timestep TODO: want to have m3 s-1
                pts_t glacier_melt;///< galcier melt output [mm/h] for the timestep TODO: want to have m3 s-1
