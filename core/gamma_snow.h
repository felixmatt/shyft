        ...
        namespace gamma_snow {
	        ...
	        class calculator {
	          ...
	          private:
	            ...
	            const boost_policy_type boost_policy = boost_policy_type();

	            double gamma_p(double a, double b) const
	            {
	                return boost::math::gamma_p(a, b, boost_policy);
	            }

	            double lgamma(double a) const
	            {
	                return boost::math::lgamma(a, boost_policy);
	            }
	                            ...
	                            double z2, const double a2, const double b2) const
	            {
	              ...
	              void calc_snow_state(const double shape, const double scale, const double y0, const double lambda, const double lwd,
	                                   const double max_water_frac, const double temp_swe, double& swe, double& sca) const
	              {
	                  double y = 0.0;
	                  double y1 = 0.0;
