            ...
            */
            struct all_response_collector {
                ...
                all_response_collector(const double destination_area, const timeaxis_t& time_axis)
                    : destination_area(destination_area), avg_discharge(time_axis, 0.0), snow_sca(time_axis, 0.0), snow_swe(time_axis, 0.0), snow_outflow(time_axis, 0.0), ae_output(time_axis, 0.0), pe_output(time_axis, 0.0) {}
            ...
            struct state_collector {
                ...
                void initialize(const timeaxis_t& time_axis,int start_step,int n_steps, double area) {
                    ...
                    ts_init(gs_albedo, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_lwc, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_surface_heat, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_alpha, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_sdc_melt_mean, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_acc_melt, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_iso_pot_energy, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                    ts_init(gs_temp_swe, ta, start_step, n_steps, fx_policy_t::POINT_INSTANT_VALUE);
                }
