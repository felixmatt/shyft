...
%#define array_dimensions(a)    (PyArray_DIMS((PyArrayObject*)(a)))  // old was(((PyArrayObject *)a)->dimensions)
%#define array_size(a,i)        PyArray_DIM((PyArrayObject*)(a),i) // old was (((PyArrayObject *)a)->dimensions[i])
%#define array_data(a)          PyArray_DATA( (PyArrayObject*)(a)) // old was (((PyArrayObject *)a)->data)
          ...
          fragment="NumPy_Utilities")
{
                              ...
                              int min_dims, int max_dims)
  {
    ...
    {
      Py_INCREF(PyArray_DESCR(ary));//(ary->descr);
      result = (PyArrayObject*) PyArray_FromArray(ary, PyArray_DESCR(ary)/*->descr*/, NPY_ARRAY_F_CONTIGUOUS);
      *is_new_object = 1;
    }
    return result;
  }
          ...
          fragment="NumPy_Macros")
{
  ...
  int require_fortran(PyArrayObject* ary)
  {
    ...
    // pre 1.7    ary->flags = NPY_FARRAY;
    PyArray_ENABLEFLAGS(ary,NPY_ARRAY_FARRAY);
    /* Recompute the strides */
    PyArray_STRIDES(ary)[0] = PyArray_STRIDES(ary)[nd-1];
    for (i=1; i < nd; ++i)
      PyArray_STRIDES(ary)[i] = PyArray_STRIDES(ary)[i-1] * array_size(ary,i-1);
    return success;
  }
}
...
%typemap(in,numinputs=0,
         fragment="NumPy_Macros") //NumPy_Backward_Compatibility,
  (DATA_TYPE ARGOUT_ARRAY1[ANY])
  (PyObject * array = NULL)
{
...
%typemap(argout,
         fragment="NumPy_Array_Requirements")//NumPy_Backward_Compatibility,
  (DATA_TYPE** ARGOUTVIEW_FARRAY3, DIM_TYPE* DIM1, DIM_TYPE* DIM2, DIM_TYPE* DIM3)
{
  npy_intp dims[3] = { *$2, *$3, *$4 };
