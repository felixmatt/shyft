...
namespace shyft {
  namespace api {
    %template(PTHSKCellAllStatistics) basic_cell_statistics<shyft::core::cell<shyft::core::pt_hs_k::parameter, shyft::core::environment_t, shyft::core::pt_hs_k::state, shyft::core::pt_hs_k::state_collector, shyft::core::pt_hs_k::all_response_collector>>;
      ...
      %template(PTHSKCellHBVSnowResponseStatistics) hbv_snow_cell_response_statistics<shyft::core::cell<shyft::core::pt_hs_k::parameter, shyft::core::environment_t, shyft::core::pt_hs_k::state, shyft::core::pt_hs_k::state_collector, shyft::core::pt_hs_k::all_response_collector>>;
