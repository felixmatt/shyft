...
from shyft.api.pt_gs_k import PTGSKStateIo #if different state-io is needed, they can be injected into the constructor, this one is provided for default argument

class StateRepositoryError(Exception): pass


class State(object):
    """ module internal only, persisted state in the yaml-file, kept equal to orchestration for backward compatibility
    """
