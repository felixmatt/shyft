...
cl /I".." /I"../.." /I"../../armadillo/include" /I"../../dlib" /I"../../boost" /I"%PYTHONROOT%\Include" /I"%PYTHONROOT%\lib\site-packages\numpy\core\include" /D "SWIG_PYTHON_INTERPRETER_NO_DEBUG" /D "BOOSTSERIAL" /D "BOOST_THREAD_USE_DLL" /D "BOOST_LIB_DIAGNOSTIC=1" /D "BOOST_NUMERIC_ODEINT_CXX11" /D  "BOOST_ALL_DYN_LINK=1" /D "_WINDOWS" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_WINDLL" /D "_MBCS" /D "_CRT_SECURE_NO_WARNINGS" /WX- /Zc:forScope /Gd /MD /EHsc /GS- /W1 /Gy /Zc:wchar_t /bigobj /Zi /Gm- /Ox /fp:precise /Fd"vc120.pdb"  /c  ../core/utctime_utilities.cpp  ../api/python/api_wrap.cpp  ../core/sceua_optimizer.cpp ../core/dream_optimizer.cpp ../api/api.cpp
