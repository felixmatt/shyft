...
link /OUT:api\___init__.pyd /Libpath:..\..\shyft-data\blaslapack /libpath:%PYTHONROOT%\libs /MANIFEST /NXCOMPAT /PDB:"_api.pdb" /DYNAMICBASE "blas_win64_MT.lib" "lapack_win64_MT.lib" "kernel32.lib" "user32.lib"  api_wrap.obj  utctime_utilities.obj sceua_optimizer.obj dream_optimizer.obj api.obj /IMPLIB:"_api.lib" /DEBUG /DLL /MACHINE:X64 /OPT:REF /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /MANIFESTUAC:"level='asInvoker' uiAccess='false'" /ManifestFile:"_api.pyd.intermediate.manifest" /OPT:ICF /ERRORREPORT:PROMPT /NOLOGO /TLBID:1 
